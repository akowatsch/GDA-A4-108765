...
Following data was used to replicate the article in Markdown:

- **Notebook-File (Pandas.ipynb)**
   - This file was created (Markdown and Code cells) to create the resulting HTML-File.

- **HTML-File (Pandas.html)**
   - This file was generated from the the Notebook-File.
